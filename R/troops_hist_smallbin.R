troops_hist_smallbin <- function(iiss_afghan){
  ...
  hist(my_df$percent, breaks = 24,freq = FALSE, main = "Troop Contributions to ISAF (2001-2005)", xlab = "", ylab = " ", xlim = c(0, 3), axes = FALSE, col = "grey")
  axis(1, seq(0, 3, by = .1))
