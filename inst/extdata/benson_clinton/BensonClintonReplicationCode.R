...
alldata <- read_dta(file = "BensonClintonMainNonAggression.dta")
...
#Dimension1 <- MCMCfactanal(
#  ~ lallycount + lsumcap + polity + maxmajpow + distance + s_wt_glo,
#  data = alldata,
#  factors = 1,
...
#depth <- MCMCfactanal(
#  ~ milcontact + commondef + intcom + milaid + base + contrib + organ1 + 
#  ecaid + secrecy,
#  data = alldata,
#  factors = 1,
...
#  compel + deterministic + unconditional + offenseatop + defenseatop 
#  + neutatop + consultatop,
#  data = alldata,
#  factors = 1,
...
AllianceDataScore <- as.data.frame(cbind(alldata$atopid, Dimension1.score, 
