...
Note -- there are only a handful of unique values for alliance depth estimates because the number of discrete U.S. alliance treaties during our dataset is not large. There just happen to be a large number of countries in those alliances. 
