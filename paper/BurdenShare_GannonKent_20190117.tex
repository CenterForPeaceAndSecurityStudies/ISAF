...
\section{Theory of Joint Warfare as a Costly Signal}
	...
	\subsection{Benefits of Over-contributing Forces}
		...
		To avoid the statistical complications of modeling a curvilinear relationship, we reconceptualize the independent variable as a latent alliance relationship rather than actual alliance relationship. For any dyad, 
